...
const TransactionInfoCard = ({ key, title, icon, date, amount, hideDeleteBtn, type, onDelete }) => {

  const getAmountStyles = () =>
    type == "income" ? "bg-green-50 text-green-500" : " bg-red-50 text-red-500"

  return (
    <div className=" group relative flex items-center gap-4 mt-2 pt-3 rounded-lg hover:bg-gray-100/60">
